...
ActiveRecord::Schema.define(version: 20150405112114) do
  ...
  add_index "reportcomments", ["comment_id"], name: "index_reportcomments_on_comment_id"
  add_index "reportcomments", ["user_id"], name: "index_reportcomments_on_user_id"
